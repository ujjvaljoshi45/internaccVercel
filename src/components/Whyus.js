                ...
                <div className="container">
                    ...
                    <div className="row mt-5">
                        <div className=" col-md-3 my-md-0 mt-4">
                            ...
                            <h6 className='text-left text-light' style={{ fontSize: "20px", fontWeight: "400", textAlign: "justify" }}>We are a leading global provider of international internships and student accommodation solutions.
                        ...
                        <div className="offset-md-1 col-md-3 my-md-0 mt-4">
                            ...
                            <h6 className='text-left text-light' style={{ fontSize: "20px", fontWeight: "400", textAlign: "justify" }}>We offer housing for international students in a number of nations, including the UK, USA, Canada, Australia, and Ireland. Most Convenient Housing: We make sure you are assigned to the most convenient housing option close to your university.</h6>
                        </div>
                        <div className="offset-md-1 col-md-3 my-md-0 mt-4">
                            <h5 className="text-center mb-3" style={{ fontSize: "26px", fontWeight: "900", color: "#C4725E" }}>International Internship</h5>
                            <h6 className='text-left text-light' style={{ fontSize: "20px", fontWeight: "400", textAlign: "justify" }}>INTERNACC has established a strategic partnership with a world-renowned organization specializing in summer internships offered at prestigious universities such as Oxford, Cambridge, and UCL.</h6>
                        </div>
                    </div>
                </div>
            </div>
